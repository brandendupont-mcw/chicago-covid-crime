...
// defined two iframes
const srcs = {
  chart: "https://datawrapper.dwcdn.net/hPCKw/32/",
  map: "https://datawrapper.dwcdn.net/9zRw1/22/",
};
...
function NeighborhoodTrends() {
  ...
  return (
    <TwoColumns
      leftColumn={
        <SectionHeadingButton title="Chicago Neighborhoods">
          <Button
      ...
      rightColumn={
        <Fragment>
          <Container>
            <DataWrapChart
              title="Chicago Crime by Neighborhood"
              frameborder="0"
