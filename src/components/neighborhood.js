    ...
    <TwoColumns
      ...
      rightColumn={
        ...
        <Container>
          ...
          <DataWrapChart title="Chicago Crime" frameborder="0" aria-label="Column Chart" id="datawrapper-chart-FxQJZ" height="750"  allowfullscreen="true" src="//datawrapper.dwcdn.net/4diEq/1/
"/></Container>
