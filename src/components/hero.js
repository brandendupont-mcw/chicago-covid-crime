    ...
    <HeroSection>
      ...
      <SectionTopComponent>
        <HeaderArticle title="Covid-19's Effect on Chicago Crime Trends"  />
          ...
          <p>This project tracks reported crime trends in Chicago on a weekly basis and Cook County jail population which updates daily. Incident data is pulled from the <a href="https://data.cityofchicago.org/Public-Safety/Crimes-2001-to-present/ijzp-q8t2">Chicago Data Portal.</a> Cook County jail data is taken from the <a href="https://www.cookcountysheriff.org/data/"> Cook County Sheriff's Office.</a></p>
