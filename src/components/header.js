    ...
    return (
      <Div article={this.props.article}>
        <LogoWrapper article={this.props.article}>
          ...
          {!this.props.article && (
            <Name article={this.props.article}>Loyola University Chicago</Name>
          )}
          {!this.props.article && <Role> Center for Criminal Justice Research, Policy, and Practice</Role>}
        </LogoWrapper>
        <div>
          <SocialLinks article={this.props.article}>
            <SocialLink
              href={`mailto:dstemen@luc.edu`}
              onMouseOver={() => this.showTooltip('Get in Touch')}
              onFocus={() => this.showTooltip('Get in Touch')}
